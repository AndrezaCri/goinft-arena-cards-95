...
interface MarketplaceCardDetailsDialogProps {
...
export function MarketplaceCardDetailsDialog({
  card,
  isOpen,
  onClose,
  onTradeClick,
  isOwned = false
}: MarketplaceCardDetailsDialogProps) {
  if (!card) return null;
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-4 text-white/70 mb-6">
              <div>
                ...
                <span className="block text-white">{card.team}</span>
              </div>
              
              <div>
                <span className="block text-sm">Posição</span>
                <span className="block text-white">{card.position}</span>
              </div>
              
              <div>
                <span className="block text-sm">Raridade</span>
                <span className="block text-white capitalize">{card.rarity}</span>
              </div>
              
              <div>
                <span className="block text-sm">ID do Card</span>
                <span className="block text-white">{card.id}</span>
              </div>
            </div>
